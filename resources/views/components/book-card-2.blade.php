...
<a wire:wire:navigate href="{{ route('homepage.book.detail', $book->slug) }}" wire:navigate>
    <div class="flex mx-3 lg:max-h-[19rem] max-h-[15rem] rounded">
        <div class="flex items-center justify-center min-h-full p-1 lg:p-2 min-w-fit">
        ...
        <div class="flex flex-col p-1 mt-1 lg:p-4 lg:mt-3">
            <h1 class="text-lg font-bold lg:text-3xl">
                {{ $book->title }}
            </h1>
            ...
            <div class="flex flex-row gap-1 my-3">
                ...
                <p class="p-0.5 text-xs border border-black rounded-lg w-fit dark:border-white lg:p-1">
                    {{ $category->name }}
                </p>
                @endforeach
            </div>
